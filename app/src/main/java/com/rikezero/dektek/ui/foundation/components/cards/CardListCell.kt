...
import com.rikezero.dektek.util.getManaSymbols
...
fun CardListCell(
    ...
    Card(
        ...
        Row {
// todo add this commented block back once all set resources are added into the project, for now it'll remain as is
//            Icon(
//                modifier = Modifier
//                    .size(16.dp)
//                    .padding(start = 4.dp),
...
//            )
            Column {
                Row(
                    ...
                    val manaSymbols = cardModel.manaCost?.getManaSymbols()
                    manaSymbols?.forEach { symbol ->
                        Icon(
                            modifier = Modifier
                                .size(16.dp)
                                .padding(start = 4.dp),
                            painter = painterResource(symbol.drawable),
                            tint = Color.Unspecified,
                            contentDescription = cardModel.name
                        )
                    }
